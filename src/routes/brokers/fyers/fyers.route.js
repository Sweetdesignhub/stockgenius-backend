...
router.post('/fetchTradesAndSave/:userId', fetchTradesAndSave);
router.post('/fetchOrdersAndSave/:userId', fetchOrdersAndSave);
...
router.get(
  '/fetchAllFyersUserDetails/:userId', verifyUser,fetchAllFyersUserDetails
);
