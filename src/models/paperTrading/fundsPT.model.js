...
const FundsSchema = new Schema(
  {
    totalFunds: { type: Number, default: 2000000, required: true }, // Total account balance
    availableFunds: { type: Number, default: 2000000, required: true }, // Liquid cash for trading
    ...
    openingBalance: { type: Number, default: 2000000 }, // Starting balance of the account
